...
@triton.jit
def load_block_with_pred_2d(
    ptr, skip_boundary_check_0: tl.constexpr, skip_boundary_check_1: tl.constexpr
):
    if not skip_boundary_check_0 and not skip_boundary_check_1:
...
@triton.jit
def store_block_with_pred_2d(
    ptr, value, skip_boundary_check_0: tl.constexpr, skip_boundary_check_1: tl.constexpr
):
    if not skip_boundary_check_0 and not skip_boundary_check_1:
